...
ASoulslikeCombatCharacter::ASoulslikeCombatCharacter()
{
...
void ASoulslikeCombatCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ASoulslikeCombatCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASoulslikeCombatCharacter::Move);
...
void ASoulslikeCombatCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASoulslikeCombatCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
